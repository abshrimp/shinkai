...
class Sprite {
	...
	render( stage, canvas ) {
		...
		bmp.sourceRect = new createjs.Rectangle(_frameX * this.width, _frameY * this.height, this.width, this.height);
